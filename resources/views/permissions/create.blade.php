  ...
  <div class="py-6">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="rounded-lg border bg-white shadow-sm">
        <div class="p-6">
          <div class="mb-8">
            <h3 class="text-2xl font-semibold leading-none tracking-tight">Create Permission</h3>
            <p class="mt-2 text-sm text-gray-500">Add a new permission to the system.</p>
          </div>
